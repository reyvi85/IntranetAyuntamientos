    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                @if ($modalModeDestroy)
                    <h3 class="text-center"> Confirma realmente que desea eliminar este Evento<br> <span class="text-danger font-weight-bolder">{{$name}}</span>?</h3>
                @else
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group text-center">
                            ...
                            @elseif(!is_null($imageCategory))
                                <img class="img-fluid img-thumbnail rounded" src="{{asset($imageCategory)}}">
                            @endif
                        </div>
