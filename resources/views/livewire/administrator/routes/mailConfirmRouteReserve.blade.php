...
<p>Su reserva ha sido <b>Confirmada</b> para la fecha <b>{{carbon::parse($data->fecha_reserva)->isoFormat('dddd D \d\e MMMM \d\e\l Y / HH:mm')}}</b> para <b>{{$data->num_person}} personas</b>.</p>
